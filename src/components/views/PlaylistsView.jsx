            ...
            <section className="hero mt-4">
                <div className="hero-main">
                    <div className="hero-icon">
                        <svg viewBox="0 0 24 24"><rect x="3" y="6" width="18" height="12" rx="3"/><path d="m10 9 5 3-5 3Z"/></svg>
                    </div>
            ...
            <section className="stats">
                <div className="stat">
                    <div className="stat-icon" style={{color:"var(--blue)", background:"var(--blue-soft)"}}>
                        <svg viewBox="0 0 24 24"><rect x="4" y="6" width="16" height="14" rx="2"/><path d="M8 4h8"/></svg>
                    </div>
            ...
            <section className="library">
                <div className="section-head">
                    <div className="section-title">
                        <i>
                            <svg viewBox="0 0 24 24"><path d="M4 19.5V5.8A2.8 2.8 0 0 1 6.8 3H20v16H6.5A2.5 2.5 0 0 0 4 21.5"/></svg>
                        </i>
