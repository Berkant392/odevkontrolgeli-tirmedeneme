...
const ClassDetail = ({ classData, onBack, updateClassInDb, onSelectStudent }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ÖĞRENCİ BİLGİLERİ DÜZENLEME MODALI */}
      <AnimatePresence>
        {editingStudent && (
                ...
                >
                    ...
                    <div className="p-4 border-t border-slate-100 bg-slate-50 flex gap-2 justify-end">
                        ...
                        <button 
                            ...
                            className="px-6 py-2 bg-brandPurple text-white text-sm font-bold rounded-xl hover:bg-purple-700 transition-colors flex items-center gap-2 shadow-md shadow-purple-200"
                        >
                            <Save size={16}/> Kaydet
                        </button>
                    </div>
