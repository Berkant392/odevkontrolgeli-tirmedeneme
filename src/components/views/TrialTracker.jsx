                    ...
                    {chartData.length > 0 ? (
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={chartData} margin={{ top: 5, right: 20, left: 0, bottom: 0 }}>
                                ...
                                {targetNet && !isNaN(parseFloat(targetNet)) && (
                                    <ReferenceLine y={parseFloat(targetNet)} label={{ position: 'insideTopLeft', value: 'HEDEF', fill: '#ef4444', fontSize: 11, fontWeight: 'black' }} stroke="#ef4444" strokeDasharray="3 3" strokeWidth={2} />
                                )}
