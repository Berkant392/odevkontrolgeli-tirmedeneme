            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-7 space-y-6">
                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200">
                        <h2 className="text-sm font-black text-slate-800 mb-4 uppercase tracking-widest flex items-center gap-2">
                            <FileText size={16} className="text-brandPurple" /> 1. Şablon Seçimi
                        </h2>
                ...
                <div className="lg:col-span-5">
                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 sticky top-6">
                        <h2 className="text-sm font-black text-slate-800 mb-4 uppercase tracking-widest flex items-center gap-2">
                            <User size={16} className="text-brandPurple" /> 2. Hedef Kitle
                        </h2>
                                        ...
                                        <div className="bg-slate-50 p-3 flex items-center justify-between cursor-pointer select-none" onClick={() => toggleClassExpand(cls.id)}>
                                            <div className="flex items-center gap-3">
                                                <button 
                                                    ...
                                                    className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${isAllSelected ? 'bg-brandPurple border-brandPurple text-white' : isIndeterminate ? 'bg-brandPurple/20 border-brandPurple text-brandPurple' : 'border-slate-300 bg-white'}`}
                                                >
                                                    {isAllSelected && <Check size={14} />}
                                                    {isIndeterminate && <div className="w-2.5 h-0.5 bg-brandPurple rounded-full"></div>}
                                                </button>
                                                        ...
                                                        {students.map(std => {
                                                            ...
                                                            return (
                                                                <div key={std.id} className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-lg cursor-pointer" onClick={() => toggleStudentSelect(cls.id, std.id)}>
                                                                    <div className="flex items-center gap-3">
                                                                        <div className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${isSelected ? 'bg-brandPurple border-brandPurple text-white' : 'border-slate-300'}`}>
