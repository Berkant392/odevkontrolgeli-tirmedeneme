...
const BottomNav = ({ activeTab, setActiveTab, isVip, isTeacherMode }) => {
    ...
    return (
        <div className={`fixed bottom-0 left-0 w-full z-50 lg:hidden ${isVip ? 'glass-panel-vip border-t border-yellow-500/20' : 'glass-panel border-t border-slate-200'} shadow-[0_-10px_40px_rgba(0,0,0,0.05)]`}
