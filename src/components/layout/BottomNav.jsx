...
import { LayoutDashboard, BookOpenCheck, Compass, MonitorPlay, Target, Layers, Users, Crown, Library, BellRing, Settings, Menu, X, Plus, Edit2, Check, LogOut, Home, Map } from 'lucide-react';
...
const ALL_STUDENT_ITEMS = [
    ...
    { id: 'subject-study', icon: <Map size={22} />, label: 'Konular' },
