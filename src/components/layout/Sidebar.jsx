...
const Sidebar = ({ 
    ...
    const studentMenu = [
        { id: 'home', label: 'Ana Sayfa', icon: Home, action: () => { if(window.handleBottomNavNavigate) window.handleBottomNavNavigate('home'); } },
        { id: 'homework', label: 'Ödevlerim', icon: BookOpen, action: () => { if(window.handleBottomNavNavigate) window.handleBottomNavNavigate('homework'); } },
        { id: 'trialTracker', label: 'Net Takibi', icon: Target, action: () => { if(window.handleBottomNavNavigate) window.handleBottomNavNavigate('trialTracker'); } },
    ];
