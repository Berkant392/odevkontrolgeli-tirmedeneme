...
const Sidebar = ({ 
    ...
    const teacherMenu = [
        ...
        { id: 'send-notification', label: 'Bildirimler', icon: Bell },
    ...
    const studentMenu = [
        ...
        { id: 'curriculum', label: 'Müfredat', icon: Map },
        { id: 'playlists', label: 'Videolar', icon: Youtube },
        { id: 'trialTracker', label: 'Denemeler', icon: Target },
        { id: 'questions', label: 'Kütüphane', icon: BrainCircuit }
    ];
