...
import { Home, LayoutDashboard, BookOpenCheck, Compass, MonitorPlay, Target, Layers, Users, Crown, ClipboardList, MessageCircle, BellRing, Library, X, LogOut, Settings, ChevronRight, ChevronLeft, Rocket, Map } from 'lucide-react';
...
const Sidebar = ({ 
    ...
    const teacherMenu = [
        ...
        { id: 'subject-study', label: 'Konu Haritası', icon: Map },
