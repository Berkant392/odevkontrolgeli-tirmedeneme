...
const Sidebar = ({ 
    ...
    const activeStudentSession = (currentUserRole === 'vip-student' || currentUserRole === 'student') && Array.isArray(liveSessions)
    ...
    const teacherMenu = [
        ...
        { id: 'live-sessions', label: 'Canlı Ders Paneli', icon: Video },
    ...
    const studentMenu = [
        ...
        { id: 'live-sessions', label: 'Canlı Derslerim', icon: Video }
    ];
