...
const VirtualAgentCursor = () => {
    ...
    const executeInteraction = async (element, actionType, text, resolve) => {
        ...
        if (actionType === 'click') {
            ...
            // React 16+ uyumlu Native Value Setter (State güncellemeleri için zorunlu)
            ...
            setReactValue(element, ''); // Alanı boşalt
            ...
            for (let i = 0; i < typoText.length; i++) {
                setReactValue(element, element.value + typoText[i]);
            ...
            if (makeTypo) {
                ...
                for (let i = 0; i < 2; i++) {
                    setReactValue(element, element.value.slice(0, -1));
                ...
                for (let i = 0; i < remainingText.length; i++) {
                    setReactValue(element, element.value + remainingText[i]);
