...
// 🎯 ANA BİLEŞEN
// ═══════════════════════════════════════════════════════════════
const AssistantModal = ({ classes, allTrials = [], updateClassInDb, onClose, initialStudent, reminders = [], setReminders }) => {
    // ════════ STATE ════════
...
8. GÖREV KUYRUĞU VE ReAct DÖNGÜSÜ: Aynı anda birden fazla görev verilirse (Örn: "Ahmet'e 100 gir, Ayşe'yi aç..."), bunları içsel düşüncende sıraya koy. Her işlemi TEK TEK "simulate_app_action" ile gerçekleştir ve dönen sonucu bekle.
9. PROAKTİF İÇERİK OLUŞTURMA: Ekranda var olmayan bir şeyi (örn: yeni ödev konusu) eklemen istenirse, ilgili inputa "type" eylemi ile yaz. Ancak ardından "EKLE" veya "KAYDET" butonuna SEN TIKLAMA.
10. TARİH/SAAT VE KAYNAK EKLEME:
    - Kullanıcı "Tarih ve saat ekle" veya "Zaman gir" dediğinde "simulate_app_action" fonksiyonunu kullanarak hedef olarak "tarih saat ekle" metnini kullan ve "type" eylemi ile (Örn: 2026-05-30T14:30) yaz.
    - Kullanıcı bir ödeve "Kaynak ekle" dediğinde hedef olarak "KAYNAK" kelimesini kullanarak "click" eylemi yap.
