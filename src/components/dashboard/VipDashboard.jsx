...
const VipDashboard = ({ vipClasses, onOpenClass, onNewVipClass, startLiveSession }) => {
                    ...
                    {vipClasses.map(cls => (
                        <motion.div key={cls.id} whileHover={{ y: -4, scale: 1.01 }} onClick={() => onOpenClass(cls)} className="bg-slate-900 p-6 rounded-3xl border border-slate-800 shadow-md hover:shadow-vip-glow transition-all cursor-pointer flex flex-col justify-between min-h-[160px] group relative overflow-hidden">
                            ...
                            <div className="mt-5 relative z-10">
                                ...
                                <div className="flex justify-between items-center mt-3 pt-3 border-t border-slate-800/60 relative z-20">
                                    ...
                                    <button 
                                        onClick={(e) => { e.stopPropagation(); startLiveSession(cls); }}
                                        className="text-[10px] font-black tracking-wider text-slate-900 bg-gradient-to-tr from-amber-400 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 px-3.5 py-1.5 rounded-xl shadow-vip-glow transition-all hover:scale-105"
                                    >
                                        DERSİ BAŞLAT
                                    </button>
                                </div>
