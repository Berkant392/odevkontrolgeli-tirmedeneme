...
const TeacherDashboard = ({ regularClasses, vipClasses, onOpenClass, onNewClass, onNewVipClass, notifications }) => {
    ...
    const handleSendNotification = async () => {
        ...
        if (selectAllClasses && selectAllVips) {
            ...
            // Seçili VIP öğrencileri ekle
            if (selectAllVips) {
                targetStudentIds.push(...allVipStudents.map(s => s.id));
            } else {
                targetStudentIds.push(...selectedVips);
            }
            // Tekrarları temizle
        ...
        try {
            ...
            // 1. Firebase'e Kaydet (Geçmiş ve uygulama içi bildirimler için)
            ...
            // 2. Netlify Fonksiyonuna İstek At (OneSignal Arka Plan Bildirimi için)
            // AI UYARISI: DO NOT MODIFY THIS FETCH CALL
            try {
                ...
                // Uygulama çökmeyecek, sadece push gitmemiş olacak.
            }
