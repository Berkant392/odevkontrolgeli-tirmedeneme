            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-3 md:gap-4">
                        <div className={`w-14 h-14 md:w-20 md:h-20 shrink-0 rounded-2xl flex items-center justify-center text-xl md:text-3xl font-black shadow-lg border-2 ${isVip ? 'bg-slate-800 text-vipGold border-yellow-500/30' : 'bg-white text-brandPurple border-white/20'}`}>
