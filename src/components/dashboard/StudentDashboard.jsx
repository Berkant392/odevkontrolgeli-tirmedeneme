...
import { Target, AlertCircle, Clock, BookOpen, TrendingUp, ChevronRight, Calendar, Youtube } from 'lucide-react';
...
const StudentDashboard = ({ classes, currentUserRole, loggedInStudent, onOpenClass, setView, countdownConfig, selectedClass }) => {
    ...
    return (
        ...
        >
            ...
            {/* 📦 KOMPAKT BİLGİ KARTLARI (3 sütun grid) */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                ...
                >
                    <div className={`w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center transition-all ${isVip ? 'bg-amber-500/10 text-amber-400 group-hover:bg-amber-50 group-hover:text-white' : 'bg-red-50 text-red-650 group-hover:bg-red-600 group-hover:text-white'}`}>
