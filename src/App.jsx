    ...
    return (
        <div className={`flex h-screen overflow-hidden ${currentUserRole === 'vip-student' ? 'bg-slate-900' : 'bg-lightBg'}`}>
            ...
            <div id="app-content-wrapper" className="flex-1 flex flex-col relative overflow-hidden">
                    ...
                    <header 
                        className={`no-print shrink-0 sticky top-0 z-20 transition-all duration-500 ${currentUserRole === 'vip-student' ? 'bg-slate-800/90 border-b border-slate-700 shadow-md' : 'bg-white border-b border-slate-200 shadow-sm'}`}
