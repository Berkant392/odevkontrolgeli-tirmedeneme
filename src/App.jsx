        ...
        <div className={`flex h-screen overflow-hidden ${currentUserRole === 'vip-student' ? 'bg-slate-900' : 'bg-lightBg'}`}>
            ...
            <div className="flex-1 overflow-y-auto pb-24 md:pb-32 transition-colors duration-1000 relative">
                ...
                <AnimatePresence mode="wait">
                    ...
                    {!isTeacherMode && view === 'home' && <StudentDashboard classes={classes} currentUserRole={currentUserRole} loggedInStudent={loggedInStudent} onOpenClass={openClass} setView={setView} countdownConfig={countdownConfig} liveSessions={liveSessions} joinLiveSession={joinLiveSession} selectedClass={selectedClass} />}
