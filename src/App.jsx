        ...
        <div className={`flex h-screen overflow-hidden ${currentUserRole === 'vip-student' ? 'bg-slate-900' : 'bg-lightBg'}`}>
            <Sidebar 
                ...
                setActiveTab={(tabId) => {
                    ...
                    if (tabId === 'playlists') {
                        ...
                        setView('home');
                    } else if (view === 'class-detail' || view === 'student-detail') {
                        setView('home');
                    }
                }} 
            ...
            <div className="flex-1 overflow-y-auto pb-24 md:pb-32 transition-colors duration-1000 relative">
                ...
                <AnimatePresence mode="wait">
                    ...
                    {!isTeacherMode && view === 'home' && activeTab === 'home' && <StudentDashboard classes={classes} currentUserRole={currentUserRole} loggedInStudent={loggedInStudent} onOpenClass={openClass} setView={setView} countdownConfig={countdownConfig} selectedClass={selectedClass} />}
                    ...
                    {view === 'playlists' && loggedInStudent && (
                        <PlaylistsView
                            studentId={loggedInStudent.id}
                            isTeacherMode={false}
                            showAlert={showAlert}
