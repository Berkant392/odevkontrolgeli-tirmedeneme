    ...
    return (
        <div className={`flex h-screen overflow-hidden ${currentUserRole === 'vip-student' ? 'bg-slate-900' : 'bg-lightBg'}`}>
            ...
            <div className="flex-1 flex flex-col relative overflow-hidden">
                <div className="absolute inset-0 overflow-y-auto pb-24 md:pb-32 transition-colors duration-1000" style={{ WebkitOverflowScrolling: 'touch', overscrollBehaviorY: 'contain' }}>
