...
const App = () => {
    ...
    const scheduleDeadlinePush = async (cls, topicTitle, targetDateStr) => {
        ...
        try {
            ...
            // 24 saat öncesini hesapla (Örn: yarın 00:00 -> bugün 00:00. Daha etkili olması için 1 gün önce sabah 10:00)
            const sendTime = new Date(targetDate);
            ...
            const sendAfterStr = sendTime.toString() + " GMT+0300";
