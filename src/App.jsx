...
const App = () => {
    ...
    const handleLogout = () => { localStorage.removeItem('bh_session'); setCurrentUserRole(null); setIsTeacherMode(false); setLoggedInStudent(null); setSelectedClass(null); setSelectedStudentForView(null); setView('home'); };
