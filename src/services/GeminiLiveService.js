export class GeminiLiveService {
    ...
    async connect(systemInstruction = "Sen akıllı bir eğitim asistanısın.", tools = []) {
        ...
        try {
            ...
            // 1. Model Seçimi: Kullanıcının talebi üzerine en güncel "Gemini Live" modelini zorla seçiyoruz.
            ...
            // ancak seçimi değiştirmeyeceğiz çünkü bu modelin kullanılmasını kesin olarak istiyoruz.
            try {
                        ...
                        setup: {
                            ...
                            generationConfig: {
                                ...
                                speechConfig: {
                                    voiceConfig: {
                                        prebuiltVoiceConfig: {
                                            voiceName: "Kore" // Neşeli ve daha enerjik genç kadın sesi
                                        }
                                    }
                                }
                            },
